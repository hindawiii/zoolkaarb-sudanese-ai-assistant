...
const OUTFIT_VARIANTS: Record<string, string> = {
  ...
  // ===== Premium Abaya Library (reference-accurate) =====
  "w-abaya-pearl-sleeves": "Replace clothing with a luxury black flowing Abaya with wide dramatic sleeves densely embroidered with white pearl and silver beadwork along the cuffs, and a matching black hijab with a pearl-embroidered edge framing the face. Ultra-loose silhouette, matte black crepe fabric, boutique studio look.",
  "w-abaya-palm-silver": "Replace clothing with a long black Nida Abaya featuring elegant silver palm-frond embroidery cascading down the sleeves and along the hem, straight loose cut, closed front, with a plain black matching hijab. Understated Gulf luxury.",
  "w-abaya-floral-beige-wing": "Replace clothing with a wide black butterfly-sleeve Abaya decorated with large beige and cream floral embroidery spread across the wing sleeves and one side of the body, worn with a black hijab. Loose, airy, fully covering.",
  "w-abaya-open-beige-white": "Replace clothing with an open beige/champagne Abaya coat with wide kimono sleeves worn over a long plain white modest inner dress, soft matching hijab, gentle draping, muted neutral palette.",
  "w-abaya-open-rose-belted": "Replace clothing with an open dusty-rose Abaya with a self-fabric waist belt and subtle dark embroidery on the front placket, worn over a long neutral inner dress with a coordinated hijab. Soft feminine modest street style.",
  "w-abaya-buttoned-camel": "Replace clothing with a camel/brown open Abaya coat with a front button row and a tied fabric belt, long straight sleeves, over a lighter inner maxi dress, with a matching hijab. Modest outerwear look.",
  "w-abaya-street-gulf": "Replace clothing with a contemporary Gulf street Abaya: minimalist plain grey (or black-and-white contrast) open Abaya with clean tailored lines, side pockets and a crisp matching shayla. Modern, sleek and fully modest.",
  "w-abaya-jacquard-cape-mint": "Replace clothing with a luxury jacquard crepe cape Abaya in soft mint green with textured pattern, layered cape sleeves worn over a long white inner dress, plus a matching mint hijab. Elegant boutique styling.",
  "w-abaya-sheer-sky-cloche": "Replace clothing with a sky-blue sheer ribbed cloche Abaya, flared A-line with soft pleats, worn over an opaque long white inner dress, with a coordinated light-blue hijab. Airy and modest.",
  "w-abaya-white-gold-band": "Replace clothing with a long white Abaya with a golden-beige embroidered vertical band down the front and along the cuffs, worn with a coordinated white-and-gold tarha. Refined and elegant.",
  "w-abaya-ivory-open-black": "Replace clothing with an open ivory chiffon Abaya with wide flowing sleeves worn over a plain long black inner dress, matching ivory hijab, and a soft neutral palette. Understated luxury.",
  "w-abaya-white-dotted": "Replace clothing with a wide white Sudanese/Gulf style Jalabiya-Abaya printed with fine black dots, decorated with dark braided trims and embroidery along the front placket, cuffs and hem, with a matching white headscarf.",
  "w-abaya-floral-cardigan": "Replace clothing with an open Nida cardigan Abaya covered in small all-over flower embroidery with white scalloped wavy edging on the front and cuffs, in beige or black, worn over a plain inner dress with a matching hijab.",
  "w-jilbab-bat-sleeve": "Replace clothing with a closed one-piece Nida prayer Jilbab with wide bat-wing sleeves and an attached integrated head covering that fully covers the hair, shoulders and chest, in a soft solid tone (mint, blush, lilac, red, grey or beige). Very loose, floor length.",
  "w-abaya-2pc-ribbon-set": "Replace clothing with a two-piece Dubai Abaya set: a long closed Abaya with vertical ribbon-tape embroidery down the front panel and on the sleeves, plus a matching coordinated tarha, in a soft color (blush, sky blue, sage, grey, mocha or black).",
  "w-abaya-satin-bows": "Replace clothing with a glossy satin Abaya with a hidden button front and scattered small embroidered bow motifs across the fabric, in grey, coffee brown or black, with a matching satin hijab. Soft sheen, fluid drape.",
  "w-abaya-pastel-plain": "Replace clothing with a plain long pastel Abaya (white, blush pink, sky blue, grey, mocha or mauve) with clean minimal lines, soft ruffled cuffs and a matching plain hijab. Simple, elegant, fully covering.",
  "w-abaya-crepe-belted-pockets": "Replace clothing with an open crepe cardigan Abaya with a tied waist belt, side pockets and elasticated cuffs, in blush, brown, grey, olive or white, worn over a plain inner maxi dress with a coordinated hijab.",
  "w-abaya-satin-floral-emerald": "Replace clothing with an open glossy satin Abaya in emerald green or black with rich floral embroidery flowing over the wide sleeves, worn over a plain inner dress with a matching satin hijab. Evening-luxury modest look.",
  "w-jilbab-2pc-khimar": "Replace clothing with a two-piece prayer set: a long loose Khimar covering the head, shoulders and chest, paired with a matching floor-length loose dress, in a single solid color (purple, grey, pink, burgundy, blue, brown, beige, green, red or black).",
  // Casual
