...
const FORMAL_OPTIONS_FEMALE = [
  ...
  { id: "w-abaya-pearl-sleeves", labelAr: "عباية سوداء لؤلؤية", labelEn: "Pearl-sleeve Abaya", emoji: "🦪" },
  { id: "w-abaya-palm-silver", labelAr: "عباية تطريز نخيل فضي", labelEn: "Silver palm Abaya", emoji: "🌴" },
  { id: "w-abaya-floral-beige-wing", labelAr: "عباية أكمام جناحية بزهور", labelEn: "Floral wing Abaya", emoji: "🌼" },
  { id: "w-abaya-open-beige-white", labelAr: "عباية مفتوحة بيج", labelEn: "Open beige Abaya", emoji: "🥂" },
  { id: "w-abaya-open-rose-belted", labelAr: "عباية وردية بحزام", labelEn: "Belted rose Abaya", emoji: "🌷" },
  { id: "w-abaya-buttoned-camel", labelAr: "عباية بنية بأزرار", labelEn: "Buttoned camel Abaya", emoji: "🧴" },
  { id: "w-abaya-street-gulf", labelAr: "عباية ستريت خليجية", labelEn: "Gulf street Abaya", emoji: "🕶️" },
  { id: "w-abaya-jacquard-cape-mint", labelAr: "عباية كيب جاكار منت", labelEn: "Mint jacquard cape", emoji: "🌿" },
  { id: "w-abaya-sheer-sky-cloche", labelAr: "عباية كلوش سماوية", labelEn: "Sky cloche Abaya", emoji: "💙" },
  { id: "w-abaya-white-gold-band", labelAr: "عباية بيضاء بشريط ذهبي", labelEn: "White-gold band Abaya", emoji: "🤍" },
  { id: "w-abaya-ivory-open-black", labelAr: "عباية عاجية فوق أسود", labelEn: "Ivory over black", emoji: "🕯️" },
  { id: "w-abaya-white-dotted", labelAr: "عباية بيضاء منقطة", labelEn: "Dotted white Abaya", emoji: "⚫" },
  { id: "w-abaya-floral-cardigan", labelAr: "كارديجان مطرز زهور", labelEn: "Floral cardigan Abaya", emoji: "🌸" },
  { id: "w-jilbab-bat-sleeve", labelAr: "جلباب صلاة كم وطواط", labelEn: "Bat-sleeve Jilbab", emoji: "🕌" },
  { id: "w-abaya-2pc-ribbon-set", labelAr: "طقم عباية وطرحة", labelEn: "2-piece ribbon set", emoji: "🎀" },
  { id: "w-abaya-satin-bows", labelAr: "عباية ساتان بفيونكات", labelEn: "Satin bows Abaya", emoji: "🎗️" },
  { id: "w-abaya-pastel-plain", labelAr: "عباية سادة باستيل", labelEn: "Plain pastel Abaya", emoji: "🪶" },
  { id: "w-abaya-crepe-belted-pockets", labelAr: "عباية كريب بحزام وجيوب", labelEn: "Belted crepe Abaya", emoji: "👜" },
  { id: "w-abaya-satin-floral-emerald", labelAr: "عباية ساتان زمردية", labelEn: "Emerald satin Abaya", emoji: "💚" },
